...
function updateVideoPlayerSrc() {
    ...
    if (currentVideo.endsWith('.mp4')) {
        ...
        videoPlayer.src = `./../assets/videos/protection/${currentVideo}`;
        videoPlayer.load();
        ...
        imagePlayer.src = `./../assets/videos/protection/${currentVideo}`;
    }
...
function updateContainerHeight() {
    ...
    const headerControlsHeight = header.clientHeight + controls.clientHeight;
